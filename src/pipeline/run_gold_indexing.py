...
if not any(isinstance(h, logging.FileHandler) and 'gold.log' in getattr(h, 'baseFilename', '')
           for h in _root.handlers):
    _root.addHandler(logging.FileHandler(str(_log_dir / "gold.log"), mode="a", encoding="utf-8"))
